...
class Child_service extends StatelessWidget {
      ...
      home: DefaultTabController(length: 1, child: Scaffold(
        ...
        appBar: AppBar
          ...
          bottom: TabBar(
              ...
              tabs: [
                Tab(child:Container(width: 150,decoration: BoxDecoration(borderRadius: BorderRadius.circular(2),border: Border.all(color: Colors.white,width: 1)),child: Align(child:  Text('خدمات الاطفال ',style: TextStyle(color: Colors.black87,fontSize: 18,fontFamily: "mobily",fontWeight: FontWeight.bold)),),)),
              ]),
        ),
